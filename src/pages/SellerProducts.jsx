    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex justify-between items-start mb-8">
        <div>
          ...
          <p className="text-gray-600">Manage your product listings, inventory, and track performance</p>
        </div>
        <button
            ...
            <table className="w-full">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {myProducts.map((product) => {
                  ...
                  const isEditingThisStock = editingStock === (product._id || product.id);
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        {isEditingThisStock ? (
                          <div className="flex items-center space-x-2">
                            ...
                            />
                            <button
                              onClick={() => handleStockSave(product._id || product.id)}
                          ...
                          <div 
                            className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium cursor-pointer ${stockStatus.bg} ${stockStatus.color}`}
